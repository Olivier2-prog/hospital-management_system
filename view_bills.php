...
<head>
    ...
    <title>View Bills - Admin Panel</title>
    ...
    <nav>
        <ul>
            ...
            <li>
                Billings
                <ul>
                    <li><a href="view_bills.php" class="active"><i class="fa fa-file-invoice-dollar"></i>View Bills</a></li>
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td class="action-btns">
                        <a href="delete_bill.php?id=<?php echo $bill_id; ?>" class="btn delete-btn" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                        <a href="edit_bill.php?id=<?php echo $bill_id; ?>" class="btn edit-btn">Edit</a>
                    </td>
                    </tr>
        <?php
}
