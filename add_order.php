...
<head>
    ...
    <title>Make Order - Admin Panel</title>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="add_order.php" class="active"><i class="fa fa-cart-plus"></i>Add Order</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                ...
                <form action="" method="post">
                    ...
                    <label>Lab ID
                        <select name="lab_id" required>
                            <option disabled selected>Select lab ID</option>
                            <?php
                        include("connect.php");
                        $sql = "select lab_id from laboratory_exam";
                        $result = mysqli_query($con, $sql);
