...
<body>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="add_item.php"><i class="fa fa-plus-circle"></i>Add facility
                                items</a></li>
                    </ul>
                </li>
                <li>
   ...
   <main class="main-content">
    ...
    $name = $con->real_escape_string(trim($_POST['item_name']));
    $price = $con->real_escape_string(trim($_POST['unit_price']));
    $sql = "UPDATE facility_service SET item_names='$name',
    unit_price ='$price'
...
<?php   
include("connect.php");
$sql="select * from facility_service where item_id=$id";
$result=mysqli_query($con,$sql);
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        $edit_id= $row["item_id"];
        $edit_name= $row["item_names"];
        $edit_price= $row["unit_price"];
      
        ?>
              
                <form action="" method="post">
                    <label><input type="hidden" name="edit_id" value="<?php echo $edit_id; ?>"></label>
                    <label>Item Name<input type="text" name="item_name" required  value="<?php echo $edit_name;?>"></label>
                    <label>Unit Price<input type="text" name="unit_price" required value="<?php echo $edit_price;?>"></label>
