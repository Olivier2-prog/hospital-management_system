...
<aside class="sidebar">
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="add_item.php" class="active"><i class="fa fa-plus-circle"></i>Add facility items</a></li>
                </ul>
            </li>
            <li>
                Orders
    ...
    $sql = "INSERT INTO facility_service (item_names,unit_price) 
            VALUES ('$name','$price')";
...
?>
                <form action="" method="post">
                    <label>Item Name<input type="text" name="item_name" required placeholder="Enter item name"></label>
                    <label>Unit Price<input type="number" name="unit_price" required placeholder="Enter unit price"></label>
