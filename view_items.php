...
<head>
    ...
    <title>View Items - Admin Panel</title>
...
<body>
        ...
        <nav>
            <ul>
                ...
                <li>
                    Facility Items
                    <ul>
                        <li><a href="view_items.php" class="active"><i class="fa fa-hospital"></i>View Facility items</a></li>
    ...
    <main class="main-content">
        ...
        <table>
            ...
            $select="select * from facility_service";
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td class="action-btns">
                        <a href="delete_item.php?id=<?php echo $id;?>" class="btn delete-btn" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                        <a href="edit_item.php?id=<?php echo $id; ?>" class="btn edit-btn">Edit</a>
                    </td>
                    </tr>
                    <?php 
                    }
