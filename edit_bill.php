        ...
        <div class="modal">
            <div class="modal-content">
                ...
                if (isset($_POST['edit'])) {
                    ...
                    $sql = "UPDATE billing SET quantity='$quantity',
                    bill_date='$bill_date' WHERE bill_id=$edit_id";
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $edit_bill_date=$row["bill_date"];
      
        ?>
              
                <form action="" method="post">
                    <label><input type="hidden" name="edit_id" value="<?php echo $edit_id; ?>"></label>
                    <label>Bill Date<input type="date" name="bill_date" required value="<?php echo $edit_bill_date; ?>"></label>
                    <label>Quantity<input type="number" name="quantity" min="0" required value="<?php echo $edit_quantity; ?>"></label>
